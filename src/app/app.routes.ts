...
export const routes: Routes = [
    ...
    {path: 'course/:courseId', component: CoursePageComponent, children: [
        {path: 'home', component: CourseHomeComponent, children: [
        ...
        {path: 'material', component: MaterialComponent, children: [
            {path: ':materialId', component: MaterialDetailComponent}
        ]},
